...
function Checkbox({ className, ...props }: React.ComponentProps<typeof CheckboxPrimitive.Root>) {
  return (
    <CheckboxPrimitive.Root
      ...
      {...props}
    >
      {/* Radix renders the Indicator for `checked="indeterminate"` as well as
          true. Without the dash, a partially-selected group would show a tick
          and claim everything under it was granted — on a permissions screen
          that is a lie with consequences. */}
